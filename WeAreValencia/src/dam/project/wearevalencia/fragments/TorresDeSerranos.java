...
public class TorresDeSerranos extends SherlockFragmentActivity implements ViewFactory {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.torres_serrano);
